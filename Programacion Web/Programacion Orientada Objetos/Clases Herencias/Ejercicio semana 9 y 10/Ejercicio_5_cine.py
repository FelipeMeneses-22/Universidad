#Enunciado: Diseña un sistema de gestión para un cine. Crea una clase Cliente que guarde nombre y número de identificación. La clase ClienteVIP hereda de Cliente y añade un nivel VIP. También, crea una clase Pelicula con título, duración y género. Usa setters y getters para los atributos. El sistema debe permitir:

#Registrar clientes y clientes VIP.
#Registrar películas.
#Vender tiquetes asociando clientes a películas.
#Mostrar clientes, películas y tiquetes vendidos.
#Clases involucradas:
#
#Cliente: nombre, identificación.
#ClienteVIP: hereda de Cliente y añade nivel VIP.
#Pelicula: título, duración, género.
#Tiquete: cliente, película.
